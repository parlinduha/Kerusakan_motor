    ...
    <div class="row content">
      ...
      <div class="col-sm-8 text-left">
        ...
        <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="ainputgejala.php">
          ...
          <div class="form-group has-feedback">
            <label class="control-label col-sm-2" for="nama">Bagian Kerusakan</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" required name="daerah" data-error="Isi kolom dengan benar">
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
              <div class="help-block with-errors" role="alert"></div>
            </div>
          </div>
          <!-- <div class="form-group ">
            <label class="control-label col-sm-2" for="alamat">Bagian:</label>
            <div class="col-sm-10">
