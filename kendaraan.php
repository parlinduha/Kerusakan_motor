  ...
  <div class="container-fluid text-center">
    <div class="row content">
      ...
      <div class="col-sm-8 text-left">
        <h2 class="text-center">INPUT JENIS KENDARAAN</h2>
        <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="kendaraan.php">
        <div class="form-group has-feedback">
            <label class="control-label col-sm-2" for="nama_kendaraan">Nama Kendaraan:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" required name="nama_kendaraan" data-error="Isi kolom dengan benar"  placeholder="Masukan nama kendaraan">
        ...
        Kembali   
          ...
          if (isset($_POST['submit'])) {
            ...
            $query = "INSERT INTO kendaraan  SET nama_kendaraan='$nama_kendaraan'";
