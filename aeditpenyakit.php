  ...
  <div class="container-fluid text-center">
    <div class="row content">
      ...
      <div class="col-sm-8 text-left">
        ...
        <h2 class="text-center">EDIT JENIS KERUSAKAN</h2>
        <form method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              $sql = mysqli_query($konek_db, $tampil);
              while ($data = mysqli_fetch_array($sql)) {
                echo "<input disabled type='text'  class='form-control' id='jenistanaman' name='jenistanaman' value='" . $data['jenistanaman'] . "' data-error='Isi kolom dengan benar'><br>";
              }
              ?>
            </div>
          </div>
        ...
        Kembali   
          ...
          if (isset($_POST['submit'])) {
            ...
            $query = "update penyakit SET namapenyakit='" . $_POST['namapenyakit'] . "', jenistanaman='" . $_POST['jenistanaman'] . "', kulturteknis='"  . $_POST['kulturteknis']. "' WHERE idpenyakit='$id'";
