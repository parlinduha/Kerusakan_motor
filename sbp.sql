...
('G1002', 'Habis Bansin', 'Mesin', 'Mio Soul'),
('G1003', 'Mogok', 'Busi', 'Mio z'),
('G1004', 'mau kemana', 'Busi', 'Mio S'),
...
('MT-20', 'Busi', 'Bunga', 'Bawang'),
('MT-21', 'A1', 'Lainnya', 'Mio S'),
('MT-22', 'A2', 'Piston', 'Mio S'),
('MT-23', 'Busi', 'Akar', 'Tanaman'),
('MT-24', 'A3', 'Knalpot', 'Mio S'),
('MT-25', 'A4', 'Aki', 'Mio S'),
('MT-26', 'A5', 'CVT', 'Mio S'),
...
('JK01', 'Busi Bermasalah', 'Mio S', 'Mengecek jalur pengapian dan lihatlah \r\napakah ada kabel yang terbakar atau \r\nterlihat krosleting, pastikan posisi busi pas, \r\nsetting ulang setelan bahan bakar, ', '', '', ''),
('JK02', 'Bagian CVT  bermasalah', 'Mio S', 'Segera mengganti bagian CVT yang rusak \r\ndengan yang berkualitas bagius, agar tidak \r\nmengalami kerusakan yang fatal dan \r\nmerambat ke bagian mesin yang lainnya.', '', '', ''),
('JK03', ' Filter udara tersumbat', 'Mio S', 'Membersihkan karburator agar sumbatan \r\nserta kotoran dapat hilang\r\n', '', '', ''),
('JK04', 'Settingan knalpot  salah', 'Mio S', 'Mengganti knalpot disertai dengan \r\nmelakukan setting karburator.', '', '', ''),
('JK05', 'Salah setting jarum  skep', 'Mio S', 'Menggunakan lem instan, lem diteteskan \r\nsedikit pada jarum skep dan skepnya, \r\nkemudian jarum dipasang. Pastikan \r\npemasangannya benar- benar lurus agar \r\nhasilnya maksimal\r\n', '', '', ''),
('JK06', 'Komponen piston aus  atau baret', 'Mio S', 'Merawat mesin dengan baik, mengganti oli \r\nsecara rutin dan pastikan oli yang diganti \r\nmemiliki kualitas bagus, ', '', '', ''),
('JK07', ' Aki soak', 'Mio S', 'Mengisi tegangan daya atau listrik dari aki \r\n(setrum aki) dan mengecek aki secara \r\nrutin dan berkala.\r\n', '', '', ''),
