      ...
      <div class="col-sm-8 text-left">
        ...
        <form method="post">
          <div class="form-group">
            <label class="control-label col-sm-2">ID Gejala</label>
            <div class="col-sm-10">
              <?php
          ...
          <div class="form-group">
            <label class="control-label col-sm-2">Nama Gejala </label>
            <div class="col-sm-10">
              <?php
              $tampil = "SELECT * FROM gejala where idgejala='" . $_GET['id'] . "'";
              $sql = mysqli_query($konek_db, $tampil);
          ...
          <div class="form-group">
            <label class="control-label col-sm-2">Bagian Kerusakan</label>
            <div class="col-sm-10">
              <?php
              $tampil = "SELECT * FROM gejala where idgejala='" . $_GET['id'] . "'";
              $sql = mysqli_query($konek_db, $tampil);
          ...
          <div class="form-group">
            <label class="control-label col-sm-2">Jenis Kendaraan </label>
            <div class="col-sm-10">
              <?php
              $tampil = "SELECT * FROM gejala where idgejala='" . $_GET['id'] . "'";
              $sql = mysqli_query($konek_db, $tampil);
              while ($data = mysqli_fetch_array($sql)) {
                echo "<input disabled type='text'  class='form-control' id='jenistanaman' name='jenistanaman' value='" . $data['jenistanaman'] . "'><br>";
              }
              ?>
            </div>
          </div>

          <a href="gejala.php"  class="btn  btn-danger">
